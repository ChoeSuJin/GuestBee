...
package com.guestbee.matching.controller;
...
import com.guestbee.matching.action.BoardFormChangeAction;
...
public class BoardController extends HttpServlet
{
	...
	public void init(ServletConfig config) throws ServletException {	
		...
		loadProperties("com.guestbee.matching.properties.BoardCommand");
    }
	
	/**
	 * 프로퍼티 파일에서 키값과 클래스 정보를 추출하여 그것을
	 *  Map에 저장한다.
	...
	private void loadProperties(String filePath) 
	{
		...
		while (actionEnum.hasMoreElements()) 
		{
			...
			try {
				 ...
				 Action actionInstance = (Action)actionClass.newInstance(); // 클래스
				 
				 // 화면전환 Action 인지 확인한다. 화면전환 Action이면 명령어를 전달한다.
				 if(className.equals("com.guestbee.matching.action.BoardFormChangeAction")){
