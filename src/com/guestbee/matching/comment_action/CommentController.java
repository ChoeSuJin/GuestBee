...
public class CommentController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		loadProperties("com/guestbee/matching/comment_properties/CommentCommand");
	}
	...
	private void loadProperties(String filePath) {
		...
		while (actionEnum.hasMoreElements()) {
			...
			try {
				...
				Action actionInstance = (Action) actionClass.newInstance(); // 클래스의
																			// 객체를
																			// 생성
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			 ...
			 * sendRedirect : 새로운 페이지에서는 request와 response객체가 새롭게 생성된다. forward
